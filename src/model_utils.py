...
def load_lstm_components(model_path='models/lstm_demand_forecast_sales.h5',
...
def predict_demand_lstm(model, scaler, latest_data_df, n_steps_out=7, n_steps_in=14, feature_cols=['Sales', 'Order Item Quantity', 'num_orders']):
    """
